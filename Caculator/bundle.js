...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CaculatorJs = __webpack_require__(157);

	var _CaculatorJs2 = _interopRequireDefault(_CaculatorJs);

	_react2['default'].render(_react2['default'].createElement(_CaculatorJs2['default'], null), document.getElementById('caculator-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Parser = __webpack_require__(163);
	...
	exports['default'] = _react2['default'].createClass({
	  displayName: 'Caculator',

	  getInitialState: function getInitialState() {
	    return {
	      screen: '0',
	      keyboard: [{ letter: 'C', position: [0, 0], size: [1, 1] }, { letter: '±', position: [1, 0], size: [1, 1] }, { letter: '/', position: [2, 0], size: [1, 1] }, { letter: '×', position: [3, 0], size: [1, 1] }, { letter: '7', position: [0, 1], size: [1, 1] }, { letter: '8', position: [1, 1], size: [1, 1] }, { letter: '9', position: [2, 1], size: [1, 1] }, { letter: '-', position: [3, 1], size: [1, 1] }, { letter: '4', position: [0, 2], size: [1, 1] }, { letter: '5', position: [1, 2], size: [1, 1] }, { letter: '6', position: [2, 2], size: [1, 1] }, { letter: '+', position: [3, 2], size: [1, 1] }, { letter: '1', position: [0, 3], size: [1, 1] }, { letter: '2', position: [1, 3], size: [1, 1] }, { letter: '3', position: [2, 3], size: [1, 1] }, { letter: '0', position: [0, 4], size: [2, 1] }, { letter: '.', position: [2, 4], size: [1, 1] }, { letter: '=', position: [3, 3], size: [1, 2] }]
	    };
	  },
	  ...
	  onPress: function onPress(letter) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, ".button {\n  position: absolute;\n  border: 1px solid #DFDCD7;\n  border-radius: 4px;\n  font-size: 16px;\n  text-align: center;\n  line-height: 32px;\n  cursor: pointer;\n  background-color: #f6f3ee;\n  box-shadow: 0 2px 2px 0px rgba(0, 0, 0, 0.1), 0 1px 1px 0px rgba(255, 255, 255, 0.75) inset;\n}\n.button:active {\n  box-shadow: 0 1px 1px 0px rgba(0, 0, 0, 0.1), 0 -1px 1px 0px rgba(255, 255, 255, 0.75) inset;\n  background-color: #EFE7DB;\n}\n.button.clear {\n  background-color: #e27943;\n  border-color: #b64e19;\n  color: white;\n}\n.button.operation {\n  background-color: #f1ede5;\n}\n.button.equal {\n  line-height: 70px;\n  background-color: #838693;\n  border-color: #6a7c7f;\n  color: white;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Parser = (function () {
	  ...
	  _createClass(Parser, [{
	    ...
	    value: function operate() {
	      ...
	      switch (this.operation) {
	        case '+':
	          ...
	          if (resultPointLength > leftPointLength && resultPointLength > rightPointLength) {
	    ...
	    key: 'pointLength',
	    value: function pointLength(number) {
	      number += '';
	      if (number.indexOf('.') > -1) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./Caculator.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./Caculator.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports = module.exports = __webpack_require__(161)();
	exports.push([module.id, "html,\nbody {\n  width: 100%;\n  height: 100%;\n}\nbody {\n  background-color: #c5dfe5;\n  font-family: sans-serif;\n}\n.caculator {\n  width: 221px;\n  height: 254px;\n  background-color: #f0ede6;\n  padding: 12px;\n  border: 1px solid #CAC3B1;\n  border-radius: 5px;\n  color: #715d54;\n  box-shadow: 0 5px 30px 0px rgba(41, 124, 174, 0.84);\n}\n.caculator .screen {\n  height: 41px;\n  border-radius: 4px;\n  font-size: 20px;\n  font-weight: bold;\n  line-height: 41px;\n  text-align: right;\n  padding: 0 8px;\n  overflow: hidden;\n  border: 1px solid #DCD9D2;\n  box-shadow: 0 13px 30px 0px rgba(0, 0, 0, 0.1) inset;\n}\n.caculator .keyboard {\n  margin-top: 10px;\n  position: relative;\n}\n", ""]);
